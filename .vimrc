...
au BufWritePost *.adoc silent execute ':!type asciidoctor >/dev/null 2>&1 && mkdir -p $HOME/.asciidoctor/"%" && asciidoctor -r asciidoctor-diagram --quiet -o $HOME/.asciidoctor/index.html "%"'
